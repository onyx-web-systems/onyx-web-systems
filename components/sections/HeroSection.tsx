    ...
    <section ref={ref} className="relative min-h-[100dvh] flex flex-col overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px]"
          style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(32,160,32,0.07) 0%, transparent 65%)" }} />
        <div className="absolute inset-0 bg-grid opacity-100" />
        <div className="absolute bottom-0 inset-x-0 h-52 bg-gradient-to-t from-[#0A0A0A] to-transparent" />
            ...
            <div className="flex flex-col gap-7">
              ...
              >
                <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full border"
                  style={{ borderColor: "rgba(32,160,32,0.28)", backgroundColor: "rgba(32,160,32,0.05)" }}>
...
const SystemsPanel = () => (
  <div className="relative w-full max-w-[460px]">
    <div className="absolute inset-0 rounded-2xl blur-3xl opacity-[0.15]"
      style={{ background: "radial-gradient(ellipse, #20A020, transparent 70%)" }} aria-hidden="true" />

    <div className="relative rounded-2xl border overflow-hidden"
      style={{ backgroundColor: "#0F0F0F", borderColor: "rgba(255,255,255,0.08)" }}>
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-white/[0.06]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-[#3D3D3D] font-mono ml-2 tracking-wider">onyx.system</span>
        </div>
      ...
      {/* Logo */}
      <div className="flex items-center justify-center py-7 border-b border-white/[0.04]">
        <div className="relative">
          ...
          <Image src="/logo.png" alt="Onyx Web Systems" width={90} height={90}
            ...
            style={{ filter: "drop-shadow(0 0 18px rgba(32,160,32,0.28))" }} />
        </div>
      </div>
        ...
        {[
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-[11px] text-[#6B6B6B] font-medium">{m.label}</span>
              <span className="text-[11px] font-semibold" style={{ color: m.accent ? "#20A020" : "#E8E8E8" }}>
                {m.value}
              </span>
            </div>
